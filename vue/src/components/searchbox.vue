<template>
  <div class="search-box" id="search-box">
    ...
    <div class="search-form">
      ...
      <!-- 输入框 -->
      <input class="search-txt" id="search-text" name="search_msg" placeholder="输入文本搜索，左侧切换引擎"
        onkeydown="if(event.keyCode==13) document.getElementById('search-btn').click()">
      <div class='search-btn-box' id='search-btn'>
        <div class="fa-solid fa-magnifying-glass" id='search-btn-font'>
          <svg t="1684771162366" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="16262" width="32" height="32">
            <path
    ...
    <div class="search-engine" v-show="isSearchEngineShown" @mouseleave="hideSearchEngine">
      ...
      <ul class="search-engine-list">
        <li id="search-engine-0"><img src="https://www.baidu.com/favicon.ico" />
          <p>百度</p>
        </li>
        <li id="search-engine-1"><img src="https://files.codelife.cc/itab/search/google.svg" />
          <p>谷歌</p>
        </li>
        <li id="search-engine-2"><img src="https://files.codelife.cc/itab/search/bing.svg" />
          <p>必应</p>
        </li>
        <li id="search-engine-3"><img src="https://files.codelife.cc/itab/search/sougou.svg" />
          <p>搜狗</p>
        </li>
        <li id="search-engine-4"><img src="https://files.codelife.cc/itab/search/360.svg" />
          <p>360</p>
        </li>
        <li id="search-engine-5"><img src="https://files.codelife.cc/itab/search/zhihu.svg" />
          <p>知乎</p>
        </li>
        <li id="search-engine-6"><img src="https://dict.youdao.com/favicon.ico" />
          <p>有道</p>
        </li>
        <li id="search-engine-7"><img src="https://so.csdn.net/favicon.ico" />
          <p>CSDN</p>
        </li>
        <li id="search-engine-8"><img src="https://files.codelife.cc/itab/search/github.svg" />
          <p>Github</p>
        </li>
        <li id="search-engine-9"><img src="https://files.codelife.cc/itab/search/bilibili.svg" />
          <p>bilibili</p>
        </li>
      </ul>
    </div>
