<template>
  <div id="app">
    ...
    <news-column v-if="showcomponent === 'news' && scrapyFlag" :jwc="jwc" :jnews="jnews" :weibo="weibo" :zhihu="zhihu"
      :bilibili="bilibili"></news-column>
...
<script>
  ...
  export default {
    ...
    const getView = async() => {
      ...
      localStorage.setItem("todos", JSON.stringify(response.data['task']),null,2) 
